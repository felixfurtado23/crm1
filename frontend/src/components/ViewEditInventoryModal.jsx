...
const ViewEditInventoryModal = ({ item, type, onClose, onUpdate }) => {
  ...
  const handleChange = (e) => {
    ...
    } else if (name === 'openingQuantity' || name === 'minimumQuantity' || name === 'currentQuantity') {
  ...
  const getStockStatusBadge = (currentQty, minQty) => {
    if (currentQty === 0) return 'status-out-of-stock';
    if (currentQty <= minQty) return 'status-low-stock';
    ...
    <div className="modal-overlay active" onClick={onClose}>
      <div className="modal-content" onClick={(e) => e.stopPropagation()} style={{ maxWidth: '900px' }}>
        ...
        <div className="modal-body" style={{ maxHeight: '70vh', overflowY: 'auto' }}>
          {!isEdit ? (
            // View Mode
            <div className="view-inventory-details">
                ...
                <div className="form-row">
                  <div className="form-group">
                    ...
                    <div className="detail-value" style={{ 
                      ...
                      AED {formatNumber(item.costPrice)}
                    </div>
                  </div>
                  <div className="form-group">
                    ...
                    <div className="detail-value" style={{ 
                      ...
                      AED {formatNumber(item.sellingPrice)}
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="form-row">
                  <div className="form-group">
                    ...
                    <div className="detail-value" style={{ 
                      ...
                      {formatInteger(item.openingQuantity)} units
                    </div>
                  </div>
                  <div className="form-group">
                    ...
                    <div className="detail-value" style={{ 
                      ...
                      {formatInteger(item.minimumQuantity)} units
                    </div>
                  </div>
                </div>
                <div className="form-row">
                  <div className="form-group">
                    ...
                    <div className="detail-value" style={{ 
                      ...
                      {formatInteger(item.currentQuantity)} units
                    </div>
                  </div>
                  <div className="form-group">
                    <label>Stock Status</label>
                    <div className="detail-value">
                      <span className={`quantity-badge ${getStockStatusBadge(item.currentQuantity, item.minimumQuantity)}`}>
              ...
              <div className="modal-form-section">
                ...
                <div className="form-row">
                  <div className="form-group">
                    ...
                    <div style={{ position: 'relative' }}>
                      <input
                        ...
                        className="form-control"
                        value={formatInteger(formData.currentQuantity)}
                        onChange={handleChange}
                        onFocus={(e) => {
                          e.target.value = formData.currentQuantity || '';
                        }}
                        onBlur={(e) => {
                          if (e.target.value) {
                            const int = parseInt(e.target.value.replace(/,/g, ''));
                  ...
                  <div className="form-group">
                    <label>Stock Status</label>
                    <div className="detail-value">
                      <span className={`quantity-badge ${getStockStatusBadge(formData.currentQuantity, formData.minimumQuantity)}`}>
                        {getStockStatus(formData.currentQuantity, formData.minimumQuantity)}
                      </span>
                    </div>
                  </div>
                </div>
